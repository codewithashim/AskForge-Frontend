...
const KnowledgeBase = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-chatcanvas-gray-900">Knowledge Base</h1>
        <p className="text-chatcanvas-gray-500">Upload files to train your chatbot</p>
      </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add files or URLs to build your chatbot's knowledge
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <form onSubmit={handleAddUrl} className="mb-6">
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-chatcanvas-gray-500 mt-1">
                        We'll crawl the content and add it to your knowledge base
                      </p>
                    </div>
                  </form>
                </TabsContent>
